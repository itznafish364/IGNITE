...
bot = telebot.TeleBot('8066216378:AAH20METU25McUevqtsKaFiSKCuGI0H5zR8')

# @S4 OFFICIAL GRP # Admin user IDs
admin_id = ["5579438195","1604629264"]
...
"https://162.223.94.164:80",#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
"https://50.168.163.182:80",#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
"https://3.12.144.146:3128",#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
"https://50.174.7.157:80",#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
"https://12.186.205.122:80",#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
"https://50.239.72.18:80",#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
        ...
        with open(FREE_USER_FILE, "r") as file:
            ...
            for line in lines:
                if line.strip():  # @S4 OFFICIAL GRP # Check if line is not empty
                    ...
                    if len(user_info) == 2:#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
def clear_logs():
    try:
        with open(LOG_FILE, "r+") as file:
            if file.read() == "":
                response = ". No data found ."#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
def record_command_logs(user_id, command, target=None, port=None, time=None):
    ...
    if port:
        log_entry += f" | Port: {port}"#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
def add_user(message):
    ...
    if user_id in admin_id:
        command = message.text.split()#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
#script by @s4 official 🚩
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # @S4 OFFICIAL GRP # Updated to accept target, time, and port
            ...
            if time > 300:
                response = "𝗠𝗮𝗸𝗲 𝘀𝘂𝗿𝗲 𝘆𝗼𝘂 𝗮𝗿𝗲 𝗲𝗻𝘁𝗲𝗿𝗲𝗱 300 𝘀𝗲𝗰"
            else:
